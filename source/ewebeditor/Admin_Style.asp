...
Sub ShowStyleForm(sFlag)
	...
	Response.Write "<table border=0 cellpadding=0 cellspacing=0 align=center class=form1>" & _
			...
			"<tr><td align=right>备注说明：</td><td colspan=3><textarea class=textarea rows=7 cols=65 name=d_memo title='此样式的说明，更有利于调用'>" & sStyleMemo & "</textarea><input name=adddo type=submit value=发送></td></tr>" & s_Button & _
			"</form>" & _
			"</table>"
