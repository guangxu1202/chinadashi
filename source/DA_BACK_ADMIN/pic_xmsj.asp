...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="bxline">
  ...
  <tr>
    ...
    <td valign="top" class="leftnav">&nbsp;</td>
    <td>&nbsp;</td>
    <td valign="top" class="right">您的位置&gt;&gt;后台管理&gt;&gt;<span class="tag">项目实景图</span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td width="50">&nbsp;</td>
      ...
      <tr>
        <td height="500" valign="top"><p>&nbsp;</p>
          ...
          <tr>
            ...
            <%
				...
				for i=lbound(n) to ubound(n)-1
				  response.Write("<a href='../upload/"&a(i)&b(i)&"' target='_blank'>"&n(i)&"</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='success_delpic.asp?filedown="&a(i)&"&id="&id&"'>删除</a><br /><br />")
				next
				%>
                    <%
					end if
          ...
          <tr>
            ...
            <td width="89%" height="25" bgcolor="#F9F9F9">&nbsp;</a></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">项目实景图:</td>
            <td height="25" bgcolor="#F9F9F9"><input type="file" name="filex" id="file9">
              <span class="STYLE4">*实景图大小为1200*800像素</span></td>
          </tr>
          ...
          <tr>
            ...
            &nbsp;&nbsp;
              ...
              <input name="act" type="hidden" id="act" value="xmsj" />
