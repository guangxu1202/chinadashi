      ...
      <tr>
        <td height="500" valign="top"><p>&nbsp;</p>
          ...
          <tr>
            ...
            <td width="89%" height="25" bgcolor="#F9F9F9"><input name="xmmc" type="text" id="xmmc">
              *</td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">售楼热线：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="slrx" type="text" id="slrx"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">产品价格：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="cpjg" type="text" id="cpjg"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">占地面积：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="zdmj" type="text" id="zdmj"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">建筑面积：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="jzmj" type="text" id="jzmj"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">规划用途：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="ghyt" type="text" id="ghyt"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">户型面积：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="hxmj" type="text" id="hxmj"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">入住时间：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="rzsj" type="text" id="rzsj"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">公交线路：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="gjxl" type="text" id="gjxl"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">项目区位：</td>
            <td height="25" bgcolor="#F9F9F9"><input name="xmqw" type="text" id="xmqw"></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">周边配套：</td>
            <td height="25" bgcolor="#F9F9F9"><textarea name="zbpt" cols="50" rows="5" id="zbpt"></textarea></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">项目介绍：</td>
            <td height="25" bgcolor="#F9F9F9"><textarea name="xmjs" cols="50" rows="5" id="xmjs"></textarea></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">产品信息：</td>
            <td height="25" bgcolor="#F9F9F9"><textarea name="cpxx" cols="50" rows="5" id="cpxx"></textarea></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">前沿动态：</td>
            <td height="25" bgcolor="#F9F9F9"><textarea name="qydt" cols="50" rows="5" id="qydt"></textarea></td>
          </tr>
          <tr>
            <td height="25" align="center" bgcolor="#F9F9F9">&nbsp;</td>
            <td height="25" bgcolor="#F9F9F9">&nbsp;</td>
          ...
          <tr>
            ...
            <td height="25" bgcolor="#F9F9F9"><input type="file" name="file2" id="file3">
              <span class="STYLE4">*旗帜图片大小为702*220像素</span></td>
          </tr>
