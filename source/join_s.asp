...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','992','height','312','style','z-index:0;','src','images/Inbanner6','wmode','transparent','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','images/Inbanner6' ); //end AC code
    ...
    <param name="movie" value="images/Inbanner6.swf" />
    <param name="quality" value="high" />
	<param name="wmode" value="transparent">
    <embed src="images/Inbanner6.swf" wmode="transparent" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="992" height="312"></embed>
...
<div id="Main">
	<div id="Main_left">
    	<em><img src="images/joinus.jpg" /></em>
        <ul>
        	<li><a href="join.asp">职位信息</a></li>
            <li><a href="join_s.asp">校园招聘</a></li>
        </ul>
    </div>
    <div id="Main_right">
    		<img  src="images/join2.jpg" class="guide" />
	
    <div class="Main_right_content">
          <p> <strong>职位：技术部长</strong></p>
          <p>职能要求：负责********************项目</p>
          <p>学历要求：本科</p>
      <p>职位描述：负责*********项目</p>
          <br /><br />
           <p> <strong>职位：项目经理</strong></p>
          <p>职能要求：负责********************项目</p>
          <p>学历要求：本科</p>
      <p>职位描述：负责*********项目</p>
          <br /><br />
