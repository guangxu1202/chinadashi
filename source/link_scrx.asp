...
<div id="Main">
    ...
    <div id="Main_right">
    	<img src="images/fast_scrx.jpg" class="guide" />
      <div><img src="images/link_slrx.jpg" /></div>
        <h4  class="fast_h4"><img src="images/fast_guide_scrx.jpg" /></h4>
      <div class="Main_right_content">
        	<ul class="fast_sqstyle">
            	<strong>◎ 泊林映山售场热线</strong>
            	<li>热线电话：84299666、84299777</li>
                <li>售楼地址：大连市甘井子区红凌路135号</li>
                <li>备注：</li>
